 ...
 <script src="<?php echo base_url('assets/CoolAdmin-master/vendor/jquery-3.2.1.min.js'); ?>" src=""></script>
    ...
    <script src="<?php echo base_url('assets/CoolAdmin-master/jquery-easing/jquery.easing.min.js') ?>"></script>

    <!-- Page level plugin javaScript -->
    <script src="<?php echo base_url('assets/CoolAdmin-master/chart.js/Chart.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/CoolAdmin-master/datatables/dataTables.bootstrap4.js') ?>"></script>
    <script src="<?php echo base_url('assets/CoolAdmin-master/datatables/dataTables.bootstrap4.js') ?>"></script>
