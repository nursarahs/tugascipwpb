...
<body class="animsition">
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('assets/CoolAdmin-master/images/icon/avatar-06.jpg'); ?>" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('assets/CoolAdmin-master/images/icon/avatar-05.jpg'); ?>"  alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url('assets/CoolAdmin-master/images/icon/avatar-04.jpg'); ?>"  alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
    ...
    <!-- Jquery JS-->
    <script src="<?php echo base_url('assets/CoolAdmin-master/vendor/jquery-3.2.1.min.js'); ?>" src=""></script>
    <!-- Bootstrap JS-->
    ...
    <script src="<?php echo base_url('assets/CoolAdmin-master/vendor/select2/select2.min.js"> '); ?>"></script>
